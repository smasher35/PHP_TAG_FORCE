	                    ...
	                    <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown padding-Top-Nav">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="myAccountActions">
                                        <li><a href="editAccountPage.php?account_id=<?=$actualUser?>">Edit My Account <span class="glyphicon glyphicon-cog"></span></li></a><hr>
                                        <li><a href="myContentsProjects.php?owner_id=<?=$actualUser?>">     My Projects <span class="glyphicon glyphicon-book"></span></li></a>
                                        <li><a href="myContentsComments.php?owner_id=<?=$actualUser?>">     My Comments <span <i class="fa fa-comments"></i></span></li></a>
                                        <li><a href="myTags.php?owner_id=<?=$actualUser?>">     My Tags <span <i class="fa fa-tags"></i></span></li></a>
                                        <li><hr></li>
