                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="position" id="inputPosition" placeholder="Position in the institution">
                                        </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="photoUrl" id="phototUrl" placeholder="Enter Photo Url">
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="inputUrl" id="inputUrl" placeholder="Enter Personal Webpage Url">
                                    </div>

                                    <label for="inputOptionalEmail1">Alternative Email</label>
                                    <div class="input-group">
                                        <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-envelope"></span></span>
                                        <input type="email" class="form-control" name="altEmail" id="inputOptionalEmail1" placeholder="Enter alternative email">
                                    </div>
                                </div>
