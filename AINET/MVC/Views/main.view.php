    ...
    <div class="container">
        <div class="col-md-12 col-lg-offset-3" align="center">
            <ul class="nav nav-pills">
                ...
                <li role="presentation"><a href="#recentProjects"><strong id="subNavButtons">Recent
    ...
    <div id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            ...
            <div class="item active">
                <img src="<?= $projectController->getProjectImage($project->id) ?>"
                     class="carousel-inner img-responsive block" alt="<?= $project->name ?> Image">

                <div class="carousel-caption">
                    <h3><?= $project->name ?></h3>
                    <a href="projectDetails.php?project_id=<?= $project->id ?>" class="btn btn-primary button-padding">View
                        Project</a>
                </div>
            </div>
        <?php } else { ?><!-- fecha if -->
            <div class="item">
                <img src="<?= $projectController->getProjectImage($project->id) ?>"
                     class=" carousel-inner img-responsive" alt="<?= $project->name ?> Image">
            ...
            <div class="container">
                <div class="center">
                    ...
                    <small><em>Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of "de Finibus Bonorum et Malorum"
                            ...
                            ipsum dolor sit amet..", comes from a line in section 1.10.32.</em></small>
                </div>
                <div class="space"></div>
                <div class="row">
                    ...
                    <?php foreach ($recentProjects as $project) { ?>
                        <div class="col-md-3 col-sm-6 service">
                            ...
                            <a href="projectDetails.php?project_id=<?= $project->id ?>"
                               class="btn btn-primary button-padding">View Project</a>
                    ...
                    <div class="center">
                        ...
                        <div id="team">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="thumbnail">
                                        <img src="storage/Images/crew/alfredo.jpg" alt="..."
                            ...
                            <?php foreach ($lastUpdatedProjects as $project) { ?>
                                <li>
                                    <div class="  timeline-image">
                                        <img src="<?= $projectController->getProjectImage($project->id) ?>"
                                             class=" img-circle lupdate-img img-responsive" alt="<?= $project->name ?>">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="contactEmail1" name="contactEmail"
                            ...
                            <div class="form-group">
                                <div class="text-left">
                                    ...
                                    <div class="text-right button-padding">
                                        <button type="submit" name="submit" id="submit" class="btn tf-btn btn-success">
                                            Submit
                                        </button>
                                    </div>
                        </form>
