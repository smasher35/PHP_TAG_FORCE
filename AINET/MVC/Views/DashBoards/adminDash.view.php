				...
				<div class="row">
					...
					<div class="tab-content">
						<div class="tab-pane fade in active" id="accountsManagement">
							...
							<div class="panel panel-primary panel-responsive" id="panelAccountsManagement">
								<!-- Default panel contents -->
								<div class="panel-heading"><h3 class="panel-title text-center"><strong>Accounts Managment </strong></h3></div>
								<!-- Table -->
							...
							</div><!-- Fecha Painel Account Management-->
